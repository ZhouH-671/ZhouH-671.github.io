...
<video width="100%" controls style="max-width: 100%;">
    <source src="./video/Logisim_toolsintroduction.mp4" type="video/mp4">您的浏览器不支持 HTML5 视频播放。
</video>
...
Logisim官网：[logisim官网](https://cburch.com/logisim/)
...
由于launch4j版本问题，推荐大家在官网下载时下载[jar包版本](./resource/logisim-generic-2.7.1.jar)，同时这里提供了[exe版本](./resource/logisim-win-2.7.1.exe)。

如果官网无法打开，可以通过北航云盘下载：[Logisim 2.7.1](https://bhpan.buaa.edu.cn/link/AAE06D244D1DD4486EB9CACDF74DD61CB1)。

以下是Logisim官网文档：

- Beginner's tutorial: [新手教程](https://cburch.com/logisim/docs/2.7/en/html/guide/tutorial/index.html)
- The Guide to Being a Logisim User: [User Guide](https://cburch.com/logisim/docs/2.7/en/html/guide/index.html)
- Library Reference:[Logisim 指南](https://cburch.com/logisim/docs/2.7/en/html/libs/index.html)
...
- **注意：请保证模块的appearance与下图完全一致，否则可能造成评测错误**（查看模块appearance方法：在Logisim中打开相应模块后点击左上角![appearance](./image/appearance%20(1).png)按钮）
